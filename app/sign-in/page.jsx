                ...
                peer-focus:top-2 peer-focus:text-xs peer-focus:text-blue-400"
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="peer w-full p-4 pt-6 pr-12 rounded-xl bg-zinc-800 border border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-transparent text-sm appearance-none"
